...
VERSION="1.6.0"
IMAGE_NAME="TimeLogger-${VERSION}-macOS-arm64.dmg"
...
codesign --verify --deep --strict --verbose=2 "${DIST_DIR}/TimeLogger.app"

mkdir -p "${RELEASE_DIR}"
ditto "${DIST_DIR}/TimeLogger.app" "${STAGING_DIR}/Time Logger.app"
